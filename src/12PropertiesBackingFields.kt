...
* are read. we may access the variables using object.variable-name, but its get through getters
*
...
* set / get the value. we need to define custom accessors and it should be defined
* very immediate to the variable is defined, because of this condition we can't define
* custom accessors for the variables defined in primary constructor
*
...
* extra public functions which can set / get the private variables
*
...
* using 'field' which is generated by compiler with in the custom accessor block when
* we do extra operation with that field,
*
*  if we don't do extra operation within the custom accessor block, the 'field' variable is never
*  generated for the variable (argFour)
*
